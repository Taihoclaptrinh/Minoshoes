    ...
    return (
        <div className="doc-layout">
            <div className="doc-container">
                ...
                <p>We take your privacy seriously and this privacy statement explains how minoshoestore.shop.(collectively, “we,” “us,” or “our”) collect, use, share and process your information.</p>
                ...
                <h2>Promoting safety and security</h2>
                <p>
                ...
                <h1>Here is a description of the types of personal data we may collect and how we may use it:</h1>
                <h2>What Personal Data We Collect</h2>
                <h3>I. Data you provide:</h3>
                <p>
                ...
                <h3>II. Data about use of our services and products:</h3>
                <p>
                ...
                <h3>I. Providing, improving, and developing our products and services:</h3>
                <p>
                ...
                <h3>II. Communicating with you:</h3>
                <p>
                ...
                <h2>Data Disclosure or Storage, Transfer, and Processing</h2>
                <h3>I. Fulfilment of legal obligations:</h3>
                <p>
                ...
                <h3>II. For the purpose of reasonable implementation or application of this article:</h3>
                <p>
                ...
                <h3>III. Legal Compliance and Security or Protect Other Rights</h3>
                <p>
                ...
                <h2>Data Security, Integrity, and Retention</h2>
                <p>
                ...
                <h2>Contact Us</h2>
                <p>If you have any questions regarding this Privacy Statement or its implementation, here is how you can reach us via minoshoestore@gmail.com</p>
            </div>
